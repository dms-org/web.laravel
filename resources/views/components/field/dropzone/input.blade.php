<div class="dropzone-container"
     ...
     data-download-temp-file-url="{{ route('dms::file.download', '__token__') }}"
     ...
     data-temp-file-key-prefix="{{ \Dms\Web\Laravel\Action\InputTransformer\TempUploadedFileToUploadedFileTransformer::TEMP_FILES_KEY }}"
>
